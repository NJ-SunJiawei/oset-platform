...
if SETTINGS['logging']:
    sys.stdout = open('gnb_slice_sim.log','wt')
#else:
...
stats = Stats(env, base_stations, None, None, ((x_vals['min'], x_vals['max']), (y_vals['min'], y_vals['max'])))
...
if SETTINGS['logging']:
    print('Simulation has ran completely and output file created to:', 'gnb_slice_sim.log')
