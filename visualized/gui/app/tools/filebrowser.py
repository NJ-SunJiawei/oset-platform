...
from plugin import crc_32c, compress_abs_path, TextEditor
...
class FileBrowser():
    ...
    """
    def __init__(self, up_tmp_path, flt_path):     
        self.default_up_tmp_path = up_tmp_path
    ...
    def gui(self):
        ...
        self.gnd_col = [
            ...
            [sg.Text('Folder'), sg.In(self.default_up_tmp_path, size=(25,1), enable_events=True ,key='-GND_FOLDER-'), sg.FolderBrowse(initial_folder=self.default_up_tmp_path)],
        ...
        self.up_dir   = GroundDir(self.default_up_tmp_path, self.window['-GND_FILE_LIST-'])
        ...
        while True:
            ...
            if self.init_cycle:
                ...
                self.up_dir.create_file_list(self.default_up_tmp_path)
            ...
            ### File Transfer ###
                ...
                if len(self.values['-GND_FILE_LIST-']) > 0:
                    ...
                    gnd_file = self.up_dir.path_filename(filename)
                ...
                if len(self.values['-FLT_FILE_LIST-']) > 0:
                    ...
                    self.file_xfer.start_recv_file(flt_file, gnd_file, self.up_dir.create_file_list)
            ...
            ### Ground ###
                ...
                self.up_dir.create_file_list(self.values['-GND_FOLDER-'])

            elif self.event == 'Refresh':                         
                self.up_dir.create_file_list()
                ...
                if len(self.values['-GND_FILE_LIST-']) > 0:
                    ...
                    if dst_file is not None:
                        self.up_dir.rename_file(self.values['-GND_FILE_LIST-'][0], dst_file)
...
if __name__ == '__main__':
    ...
    up_tmp_path = compress_abs_path(os.path.join(os.getcwd(), '..', flt_server_path))
    
    file_browser = FileBrowser(up_tmp_path, cfs_startup_path)
