...
#define SCTP_NEW_ASSOCIATION_REQ(mSGpTR)       (mSGpTR)->msg_body.sctp_new_association_req
#define SCTP_NEW_ASSOCIATION_REQ_MULTI(mSGpTR) (mSGpTR)->msg_body.sctp_new_association_req_multi
#define SCTP_NEW_ASSOCIATION_RESP(mSGpTR)      (mSGpTR)->msg_body.sctp_new_association_resp
#define SCTP_NEW_ASSOCIATION_IND(mSGpTR)       (mSGpTR)->msg_body.sctp_new_association_ind
#define SCTP_DATA_IND(mSGpTR)                  (mSGpTR)->msg_body.sctp_data_ind
#define SCTP_DATA_REQ(mSGpTR)                  (mSGpTR)->msg_body.sctp_data_req
#define SCTP_INIT_MSG(mSGpTR)                  (mSGpTR)->msg_body.sctp_init
#define SCTP_INIT_MSG_MULTI_REQ(mSGpTR)        (mSGpTR)->msg_body.sctp_init_multi
#define SCTP_INIT_MSG_MULTI_CNF(mSGpTR)        (mSGpTR)->msg_body.sctp_init_msg_multi_cnf
#define SCTP_CLOSE_ASSOCIATION(mSGpTR)         (mSGpTR)->msg_body.sctp_close_association
