                                  ...
                                  srsran_sch_cfg_nr_t*          pdsch_cfg)
{
  ...
  // Append periodic ZP-CSI-RS附加定期ZP-CSI-RS
  ...
  //根据TS 38.211条款7.3.1.5映射到虚拟资源块，附加定期NZP-CSI-RS
  //仅适用于CRC被C-RNTI、MCS-C-RNTI、CS-RNTI或PDSCH用SPS加扰的情况
                                 ...
                                 srsran_sch_grant_nr_t*        pdsch_grant)
{
  ...
  // 5.1.2.3 Physical resource block (PRB) bundling物理资源块（PRB）绑定
  // ...
