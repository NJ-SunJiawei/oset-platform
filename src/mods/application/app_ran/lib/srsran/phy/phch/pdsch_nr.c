                           ...
                           cf_t*                        sf_symbols[SRSRAN_MAX_PORTS])
{
  ...
  // 7.3.1.4 Antenna port mapping天线端口映射
  // ... Not implemented

  // 7.3.1.5 Mapping to virtual resource blocks
  // ... Not implemented

  // 7.3.1.6 Mapping from virtual to physical resource blocks从虚拟资源块映射到物理资源块
